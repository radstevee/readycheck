...
import net.radstevee.readycheck.command.RecollectPlayersCommand;
...
public class ReadyCheckPlugin extends JavaPlugin {
    private static ReadyCheckPlugin instance;
    private static ReadyCheckState state;

    private ReadyCheckConfig config;

    public static ReadyCheckPlugin instance() {
        return instance;
    }
    ...
    public void onEnable() {
        ...
        getCommand("recollect-players").setExecutor(new RecollectPlayersCommand());
    }
}
